        ...
        if ( msg.ssid !== id && msg.message ) {
            ...
            if (request.action === DatabaseAccessService.OPEN_PRIVATE_CHANNEL && request.privateChannel) {
                ...
                createPrivateChannel( request, function() {
                    ...
                    producer.publish('new private channel created: ' + request);
                } );
            }
        }
    };
        ...
        consumer.onMessage(function(msg) {
            ...
            if (msg.ssid !== ssid && msg.message && msg.message.cmd) {
                ...
                process.nextTick(function() {
                    ...
                    consumer.publish( response, msg.message.rid );
                });
            } else {
...
DatabaseAccessService.DEFAULT_CHANNEL = '/database';
DatabaseAccessService.OPEN_PRIVATE_CHANNEL = 'openPrivateChannel';
DatabaseAccessService.COMMAND = 'cmd';
